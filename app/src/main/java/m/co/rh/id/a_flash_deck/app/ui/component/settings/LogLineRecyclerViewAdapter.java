...
public class LogLineRecyclerViewAdapter extends ListAdapter<String, RecyclerView.ViewHolder> {
    ...
    protected static class ItemCallback extends DiffUtil.ItemCallback<String> {
        @Override
