...
import m.co.rh.id.a_flash_deck.ai.ui.page.ApiKeyEntrySVDialog;
...
public class NavigatorProvider implements ProviderDisposable {
    ...
    public NavigatorProvider(Application application, Provider provider) {
        ...
        navMap.put(Routes.AI_GENERATE_DECK_FROM_IMAGE_DIALOG, (args, activity) -> new GenerateDeckFromImagePage());
